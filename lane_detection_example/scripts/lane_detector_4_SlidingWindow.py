...
from utils_1 import BEVTransform, CURVEFit, draw_lane_img
...
class IMGParser:
    def __init__(self, currentPath):
        ...
        self.videoPath = currentPath + "/scripts/2020-09-29-15-33-18.bag"
        self.cameraNo = 1
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        imgSliding, curves, lanes, ploty = image_parser.sliding_window(birdView, nwindows=8, margin=30, draw_windows=True)
