...
class pure_pursuit:
	def __init__(self):
		...
		self.motor_pub = rospy.Publisher('/ln/commands/motor/speed', Float64, queue_size=1)
		self.servo_pub = rospy.Publisher('/ln/commands/servo/position', Float64, queue_size=1)
