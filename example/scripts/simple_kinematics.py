...
class simple_kinematics:
    def __init__(self):
        ...
        self.rpm_gain = 4614
        self.streering_angle_to_servo_gain = -1.2135
    ...
    def servo_command_callback(self, msg):
        ...
        self.servo_angle_rad = (servo_value - self.steering_angle_to_servo_offset) / self.streering_angle_to_servo_gain
