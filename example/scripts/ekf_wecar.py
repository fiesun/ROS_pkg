...
class CMDParser:
    def __init__(self):
        self.speed_sub = rospy.Subscriber(
            "/sensors/core", VescStateStamped, self.sp_callback)
        self.steer_sub = rospy.Subscriber(
            "/sensors/servo_position_command", Float64, self.st_callback)
...
class ExtendedKalmanFilter:
    def __init__(self, dt=1 / 20, l_vehicle=0.5, tau=0.1, K=3.6 * 6 / 7500):
        ...
        self.esti_pub = rospy.Publisher(
            '/estimation', EgoVehicleStatus, queue_size=1)
